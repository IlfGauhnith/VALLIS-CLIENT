  ...
  if (logButton) {
    logButton.addEventListener('click', async () => {
      ...
      const notaFiscal = {
        ...
        base64__arquivo: pdfBase64  // Aqui vai o arquivo da nota fiscal, se houver
      };
      ...
      paymentComponents.forEach(component => {
        ...
        const duplicateData = {
          ...
          base64__arquivo: details.base64FileContent  // Adiciona o Base64 do arquivo PDF aqui
        };
      ...
      // Exibir JSON em uma janela ou elemento HTML (opcional)
      // document.querySelector('.json-output').textContent = jsonOutput;
    });
  } else {
